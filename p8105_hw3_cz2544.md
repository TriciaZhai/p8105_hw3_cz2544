...
The average reorder rate is 0.5985944, with average days since prior order of 17.0661259+/-10.4264178, the median is 15, range between 0, 30.

The mean number of add\_to\_cart\_order is 8.7580443+/-7.4239365, and the median is 7, range between 1, 80.

The mean number of order\_number is 17.0914101+/-16.6140365, and median is 11, range between 4, 100.
